...
describe('VehicleService', () => {
  ...
  it('should use a single HTTP call for concurrent getVehicles calls', () => {
  ...
  it('should return cached vehicles without making a second GET call', () => {
    const firstResult: Vehicle[][] = [];
    const secondResult: Vehicle[][] = [];
  ...
  it('should update cached vehicles after updateVehicle', () => {
  ...
  it('should update cached vehicles after deleteVehicle', () => {
